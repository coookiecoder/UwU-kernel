...
namespace cookie {
    void enable_cursor(const unsigned char start, const unsigned char end) {
    ...
    void update_cursor(const int line, const int column) {
        const unsigned short pos = column + line * VGA_WIDTH;
